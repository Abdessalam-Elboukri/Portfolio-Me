                    ...
                    <div class="text-center">                      
                        ...
                        <?php include 'error_login.php'; ?>
                            ...
                            <div class=" d-flex flex-column text-muted ">
                                ...
                                <input type="text" name="email" id="email-login" value="" placeholder="Enter your email"
                                    class="w-100 rounded-3 border p-2 bg-transparent form-control">
                            </div>
                            <div class=" d-flex flex-column text-muted mt-3 text">
                                <label for="">Password</label>
                                <input type="password" name="password" id="pass-login" value="" placeholder="Enter your password"
                                    class="w-100 rounded-3 border p-2 bg-transparent form-control">
                            </div>
                            ...
                            <div class="text-center mt-3">
                                <p class="text-muted " style="font-size:14px">I don't have an account<a href="signup.php" class="text-info ml-2">Sign Up</a></p>
                            </div>
                        </form>
                    </div>
                </div>
